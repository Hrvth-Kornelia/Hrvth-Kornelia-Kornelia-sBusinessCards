document.addEventListener('DOMContentLoaded', function() {
        ...
        card.addEventListener('click', function(event) {
            ...
            if (!event.target.closest('.buttons') && 
               ...
               !event.target.closest('.QRcode2') &&
                ...
                !event.target.classList.contains('close3')) {   
    ...
    const imageModal3 = document.getElementById('imageModal3');
    ...
    document.getElementById('LoyalityBtn1').addEventListener('click', function(event) {
        event.stopPropagation(); // Megakadályozza a kártya forgását
        openModal(imageModal3);  // Nyitvatartás modal megnyitása
    });
    ...
    document.getElementById('closeBtn3').addEventListener('click', function(event) {
        event.stopPropagation(); // Megakadályozza a kártya forgását
        closeModal(imageModal3); // Nyitvatartás modal bezárása
    });
